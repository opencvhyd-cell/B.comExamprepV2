...
import { RefreshCw, BookOpen, Lightbulb, MessageSquare, Target, GraduationCap, Brain, TrendingUp } from 'lucide-react';
...
export default function AITutor() {
  ...
  const [aiProvider] = useState<string>('gemini');
  ...
  // Get AI service subjects for context
  const getAIServiceSubjects = () => {
    return aiService.getAvailableSubjects();
  };
