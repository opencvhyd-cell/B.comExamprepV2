...
import { Settings, Brain, Target, User, BookOpen, Eye, Headphones, Hand, FileText, Zap, Sliders } from 'lucide-react';
...
export default function AITutorSettings() {
  ...
  const handleDifficultyChange = (field: keyof DifficultyLevel, value: any) => {
    updateDifficultyLevel({ [field]: value });
  };

  const handlePersonalityChange = (field: keyof TutorPersonality, value: any) => {
