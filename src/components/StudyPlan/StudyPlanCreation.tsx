...
export default function StudyPlanCreation({ 
  ...
  }, [planData.semester, planData.stream]);
  ...
  const generateStudyPlan = async () => {
    ...
    try {
      ...
      if (isEditing && existingPlan) {
        ...
        await studyPlanService.updateStudyPlan(existingPlan.id, updates);
        ...
        // Save to Firebase
        const planId = await studyPlanService.createStudyPlan(planToSave);
